...
echo "=== Attack of the Vine! ==="
echo ""
echo "Step 1: downloading card art (skips anything already downloaded)..."
python3 art-tools/download_set_images.py --set "Attack of the Vine!" --with-variants

echo ""
echo "Step 2: tagging with the local AI (skips anything already tagged)..."
python3 art-tools/tag_art.py --set "Attack of the Vine!" --model "gemma4:12b"

echo ""
echo "=== Done with Attack of the Vine! for now ==="

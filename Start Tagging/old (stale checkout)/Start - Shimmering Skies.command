...
echo "=== Shimmering Skies ==="
echo ""
echo "Step 1: downloading card art (skips anything already downloaded)..."
python3 art-tools/download_set_images.py --set "Shimmering Skies" --with-variants

echo ""
echo "Step 2: tagging with the local AI (skips anything already tagged)..."
python3 art-tools/tag_art.py --set "Shimmering Skies" --model "gemma4:12b"

echo ""
echo "=== Done with Shimmering Skies for now ==="

...
python3 art-tools/download_set_images.py --set "Fabled" --with-variants

echo ""
echo "Step 2: tagging with the local AI (skips anything already tagged)..."
python3 art-tools/tag_art.py --set "Fabled" --model "gemma4:12b"

echo ""
echo "=== Done with Fabled for now ==="

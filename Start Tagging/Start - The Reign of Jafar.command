...
echo "=== The Reign of Jafar ==="
echo ""
echo "Step 1: downloading card art (skips anything already downloaded)..."
python3 art-tools/download_set_images.py --set "The Reign of Jafar" --with-variants

echo ""
echo "Step 2: tagging with the local AI (skips anything already tagged)..."
python3 art-tools/tag_art.py --set "The Reign of Jafar" --model "gemma4:12b"

echo ""
echo "=== Done with The Reign of Jafar for now ==="

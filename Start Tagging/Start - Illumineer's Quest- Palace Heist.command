...
echo "=== Illumineer's Quest: Palace Heist ==="
echo ""
echo "Step 1: downloading card art (skips anything already downloaded)..."
python3 art-tools/download_set_images.py --set "Illumineer's Quest: Palace Heist" --with-variants

echo ""
echo "Step 2: tagging with the local AI (skips anything already tagged)..."
python3 art-tools/tag_art.py --set "Illumineer's Quest: Palace Heist" --model "gemma4:12b"

echo ""
echo "=== Done with Illumineer's Quest: Palace Heist for now ==="

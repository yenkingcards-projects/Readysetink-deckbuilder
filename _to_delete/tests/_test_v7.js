...
/* add/delCard now go through touchDeck(), which saves AND marks the deck
   unsaved, rather than calling saveDecks() directly. */
ok(/touchDeck\(\);renderDeck\(\);refreshTiles\(\)/.test(HTML),"…and add/delCard use it instead of renderGrid()");
